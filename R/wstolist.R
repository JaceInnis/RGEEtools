#' outputs list of Salinity data with specified parameters
...
#' @examples
#' ROI = ROI()
#' list = wstolist(ROI, "20010928", 5, 30000, 10)
wstolist = function(ROI, date, interval, scale, depth){

  band =   paste0("salinity_", depth)
